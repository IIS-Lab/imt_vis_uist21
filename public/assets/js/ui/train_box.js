class TrainBox {
     ...
     init(num_class=2) {
          ...
          if (this.divid == "Training") {
               ...
               mybutton.on("click", ()=> {
                    ...
                    this.num_class += 1
                    myobj.add_one_class(this.num_class)
     ...
     add_one_class(classid) {
          ...
          // .attr("viewBox", `0 0 ${newdiv[0].getBoundingClientRect().width} 20`)
     ...
     clear_all_shadow() {
          ...
          $(".train-class-div").each((i, obj) => {
               // $(obj).children('.control-label').show();
               // $(obj).children('.text-input').hide();
